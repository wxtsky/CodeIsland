...
final class L10nTests: XCTestCase {
    ...
    func testTurkishTranslationReturnsCorrectValue() {
        ...
        XCTAssertEqual(L10n.shared["settings_title"], "UniIsland Ayarları")
    ...
    func testKoreanTranslationReturnsCorrectValue() {
        ...
        XCTAssertEqual(L10n.shared["settings_title"], "UniIsland 설정")
    ...
    func testJapaneseTranslationReturnsCorrectValue() {
        ...
        XCTAssertEqual(L10n.shared["settings_title"], "UniIsland 設定")
    ...
    func testTurkishNumericPlaceholdersWork() {
        ...
        XCTAssertEqual(formattedUpdate, "UniIsland 1.0.19 mevcut (şimdiki: 1.0.18). İndirmek ister misiniz?")
    }
    ...
    func testKoreanNumericPlaceholdersWork() {
        ...
        let updateAvailable = L10n.shared["update_available_body"]
        let formattedUpdate = String(format: updateAvailable, "1.0.19", "1.0.18")
        XCTAssertEqual(formattedUpdate, "UniIsland 1.0.19 버전을 사용할 수 있습니다(현재: 1.0.18). 다운로드하시겠습니까?")
    }
    ...
    func testJapaneseNumericPlaceholdersWork() {
        ...
        let updateAvailable = L10n.shared["update_available_body"]
        let formattedUpdate = String(format: updateAvailable, "1.0.19", "1.0.18")
        XCTAssertEqual(formattedUpdate, "UniIsland 1.0.19 が利用可能です (現在: 1.0.18)。ダウンロードしますか？")
    }
}
