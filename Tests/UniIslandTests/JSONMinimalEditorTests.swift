...
final class JSONMinimalEditorTests: XCTestCase {
    ...
    func testReplacePreservesUnrelatedKeysOrderAndSlashesAndComments() throws {
        ...
        let newHooks: [String: Any] = [
            "PreToolUse": [
                ["matcher": "", "hooks": [["type": "command", "command": "~/.uniisland/uniisland-hook.sh", "timeout": 5]]]
            ]
        ]
    ...
    func testReplaceStringArrayPreservesSurroundingKeys() throws {
        ...
        {
          "model": "sonnet",
          "plugin": ["file:///old/uniisland.js"],
          "autoshare": false
        }
        """
        let result = try XCTUnwrap(JSONMinimalEditor.setTopLevelValue(in: original, key: "plugin", value: ["file:///new/uniisland.js"]))
        XCTAssertTrue(result.contains("\"model\": \"sonnet\""))
        XCTAssertTrue(result.contains("\"autoshare\": false"))
        XCTAssertTrue(result.contains("file:///new/uniisland.js"))
        XCTAssertFalse(result.contains("file:///old/uniisland.js"))
