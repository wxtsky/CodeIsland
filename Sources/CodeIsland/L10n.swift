...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "collab_enable": "Enable Multi-Agent Collaboration",
        "collab_enable_desc": "When an agent completes, automatically suggest sending results to another agent",
        "collab_rules": "Collaboration Rules",
        "collab_no_rules": "No rules configured. Add a rule to get started.",
        "collab_add_rule": "Add Rule",
        "collab_new_rule": "New Collaboration Rule",
        "collab_edit_rule": "Edit Collaboration Rule",
        "collab_rule_name": "Rule Name",
        "collab_trigger_source": "Trigger Agent",
        "collab_target_agent": "Target Agent",
        "collab_template": "Action Template",
        "collab_custom_hint": "Variables: {source} = agent name",
        "collab_template_content": "Template Content",
        "collab_reset_template": "Reset to Default",
        "collab_require_confirm": "Require Confirmation",
        "collab_confirm_badge": "Confirm",
        "collab_cancel": "Cancel",
        "collab_save": "Save",
        "collab_trigger": "Completed:",
        "collab_context": "Context:",
        "collab_show_detail": "Detail",
        "collab_hide_detail": "Hide",
        "collab_dismiss": "Dismiss",
        "collab_execute": "Execute",
    ]
    ...
    private static let zh: [String: String] = [
        ...
        // Collaboration
        "collaboration": "协作",
        "collab_enable": "启用多 Agent 协同",
        "collab_enable_desc": "Agent 完成任务后，自动建议将结果发送给另一个 Agent 继续处理",
        "collab_rules": "协作规则",
        "collab_no_rules": "尚未配置规则，添加一条规则开始使用。",
        "collab_add_rule": "添加规则",
        "collab_new_rule": "新建协作规则",
        "collab_edit_rule": "编辑协作规则",
        "collab_rule_name": "规则名称",
        "collab_trigger_source": "触发 Agent",
        "collab_target_agent": "目标 Agent",
        "collab_template": "动作模板",
        "collab_custom_hint": "变量: {source} = Agent 名称",
        "collab_template_content": "模板内容",
        "collab_reset_template": "恢复默认",
        "collab_require_confirm": "需要确认",
        "collab_confirm_badge": "确认",
        "collab_cancel": "取消",
        "collab_save": "保存",
        "collab_trigger": "已完成:",
        "collab_context": "上下文:",
        "collab_show_detail": "详情",
        "collab_hide_detail": "收起",
        "collab_dismiss": "忽略",
        "collab_execute": "执行",
    ]
