...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "silent_work_mode": "Silent Dynamic Island While Working",
        "silent_work_mode_desc": "Keep the mascot calm during running tasks; only completion and approval/question alerts still pop out",
    ...
    private static let zh: [String: String] = [
        ...
        "silent_work_mode": "灵动岛静默模式",
        "silent_work_mode_desc": "工作中保持图标安静，仅在任务完成或需要审批/回答问题时突出提醒",
