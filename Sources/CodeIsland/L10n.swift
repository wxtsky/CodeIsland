...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "buddy_status_pair_rejected": "Pair rejected",
        "buddy_pair_confirm_hint": "Press the BOOT button on Buddy to confirm pairing",
        "buddy_pair_rejected_hint": "This Buddy is paired with another device. Hold BOOT for 3s on Buddy to reset.",
    ...
    private static let zh: [String: String] = [
        ...
        "buddy_status_pair_rejected": "配对被拒绝",
        "buddy_pair_confirm_hint": "请按 Buddy 上的 BOOT 按钮确认配对",
        "buddy_pair_rejected_hint": "此 Buddy 已与其他设备配对。在 Buddy 上长按 BOOT 3秒可重置配对。",
    ...
    private static let ja: [String: String] = [
        ...
        "buddy_status_pair_rejected": "ペアリング拒否",
        "buddy_pair_confirm_hint": "Buddy の BOOT ボタンを押してペアリングを確認してください",
        "buddy_pair_rejected_hint": "この Buddy は別のデバイスとペアリング済みです。BOOT を3秒長押しでリセットできます。",
    ...
    private static let ko: [String: String] = [
        ...
        "buddy_status_pair_rejected": "페어링 거부됨",
        "buddy_pair_confirm_hint": "Buddy의 BOOT 버튼을 눌러 페어링을 확인하세요",
        "buddy_pair_rejected_hint": "이 Buddy는 다른 기기와 페어링되어 있습니다. BOOT를 3초간 길게 누르면 초기화됩니다.",
    ...
    private static let tr: [String: String] = [
        ...
        "buddy_status_pair_rejected": "Eşleştirme reddedildi",
        "buddy_pair_confirm_hint": "Eşleştirmeyi onaylamak için Buddy'deki BOOT düğmesine basın",
        "buddy_pair_rejected_hint": "Bu Buddy başka bir cihazla eşleştirilmiş. Sıfırlamak için BOOT'u 3sn basılı tutun.",
