// uniisland-opencode-remote-plugin — auto-generated by UniIsland
// version: v2
// Remote OpenCode event forwarding via ~/.uniisland/uniisland-remote-hook.py
import { execFile } from "child_process";

const HOOK_PATH = `${process.env.HOME}/.uniisland/uniisland-remote-hook.py`;
  ...
  return new Promise((resolve) => {
    try {
      const child = execFile("python3", [HOOK_PATH], {
        ...
        env: {
          ...process.env,
          UNIISLAND_SOCKET_PATH: SOCKET_PATH,
          UNIISLAND_REMOTE_HOST_ID: REMOTE_HOST_ID,
          UNIISLAND_REMOTE_HOST_NAME: REMOTE_HOST_NAME,
          UNIISLAND_SOURCE: "opencode",
        },
      }, (error, stdout) => {
