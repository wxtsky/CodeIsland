// uniisland-opencode-plugin — auto-generated by UniIsland
// version: v4
// OpenCode event forwarding + terminal env injection + permission/question handling
import { connect } from "net";
import { getuid } from "process";

const SOCKET = `/tmp/uniisland-${getuid()}.sock`;
...
const BRIDGE_PATH = require("path").join(require("os").homedir(), ".uniisland", "uniisland-bridge");
...
export default {
  ...
  server: async ({ client, serverUrl }) => {
    ...
    // While pending, suppress non-lifecycle events to prevent UniIsland's
    ...
    return {
      "event": async ({ event }) => {
        ...
        // always flow through so UniIsland can dismiss the stale approval/question card.
        ...
        // UniIsland's "answered externally" heuristic, which drains the pending request
