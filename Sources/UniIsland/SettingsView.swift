...
private let sidebarGroups: [SidebarGroup] = [
    SidebarGroup(title: nil, pages: [.general, .behavior, .appearance, .widgets, .mascots, .sound, .shortcuts]),
    SidebarGroup(title: "UniIsland", pages: [.remote, .hooks, .buddy, .about]),
]
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 24) {
                ...
                HStack(spacing: 12) {
                    aboutLink("GitHub", icon: "chevron.left.forwardslash.chevron.right", url: "https://github.com/wxtsky/UniIsland")
                    aboutLink("Issues", icon: "ladybug", url: "https://github.com/wxtsky/UniIsland/issues")
                }
