...
private let log = Logger(subsystem: "com.uniisland", category: "Panel")
...
class PanelWindowController: NSObject, NSWindowDelegate {
    ...
    private func updateVisibility() {
        ...
        // Always keep the panel visible (idle state shows when no sessions)
        // Removed hideWhenNoSession check to maintain idle indicator display
