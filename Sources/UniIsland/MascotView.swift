...
struct MascotView: View {
    ...
    var body: some View {
        Group {
            ...
            case "wechat":
                WeChatView(status: status, size: size)
            case "cat", "kitten", "drops", "pomodoro":
                CatView(status: status, size: size, isDraggingOver: isDraggingOver, isCoding: source == "pomodoro")
            default:
