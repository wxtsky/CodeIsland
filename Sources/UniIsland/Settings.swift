...
enum SettingsKey {
    ...
    static let systemMonitorIntervalSeconds = "systemMonitorIntervalSeconds"
    static let mediaControllerEnabled = "mediaControllerEnabled"
    static let batteryMonitorEnabled = "batteryMonitorEnabled"
    static let calendarMonitorEnabled = "calendarMonitorEnabled"
}
...
class SettingsManager {
    ...
    private init() {
        defaults.register(defaults: [
            ...
            SettingsKey.pomodoroEnabled: SettingsDefaults.pomodoroEnabled,
            SettingsKey.pomodoroDurationMinutes: SettingsDefaults.pomodoroDurationMinutes,
            SettingsKey.systemMonitorEnabled: SettingsDefaults.systemMonitorEnabled,
            SettingsKey.systemMonitorIntervalSeconds: SettingsDefaults.systemMonitorIntervalSeconds,
            SettingsKey.mediaControllerEnabled: SettingsDefaults.mediaControllerEnabled,
            SettingsKey.batteryMonitorEnabled: SettingsDefaults.batteryMonitorEnabled,
            SettingsKey.calendarMonitorEnabled: SettingsDefaults.calendarMonitorEnabled,
        ])
    }
