...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "auto_expand_on_completion_desc": "Briefly expand the panel when an agent or subagent finishes; turn off to keep UniIsland in its compact state",
        ...
        "shortcut_togglePanel_desc": "Open or close the UniIsland panel",
        ...
        "boot_sound_desc": "Play a jingle when UniIsland starts",
        ...
        "remote_hint": "The host field can be a normal hostname or an alias from your ~/.ssh/config. UniIsland installs a small remote hook script and forwards events over SSH.",
        ...
        // Window
        "settings_title": "UniIsland Settings",
        ...
        "update_available_body": "UniIsland %@ is available (current: %@). Would you like to download it?",
        "download_update": "Download",
        "later": "Later",
        "no_update_title": "Up to Date",
        "no_update_body": "UniIsland %@ is the latest version.",
        "ok": "OK",
        ...
        "update_homebrew_body": "UniIsland %@ is available. Since you installed via Homebrew, please run:",
        "update_homebrew_command": "brew upgrade uniisland",
    ...
    private static let zh: [String: String] = [
        ...
        "auto_expand_on_completion_desc": "Agent 或子 Agent 完成时短暂展开面板；关闭后 UniIsland 始终保持紧凑状态",
        ...
        "shortcut_togglePanel_desc": "展开或收起 UniIsland 面板",
        "shortcut_approve": "批准",
        ...
        "system_section": "系统",
        "boot_sound": "启动音效",
        "boot_sound_desc": "UniIsland 启动时播放提示音",
        "interaction": "交互",
        ...
        "remote_hint": "主机字段既可以填普通 hostname，也可以直接填 ~/.ssh/config 里的别名。UniIsland 会在远端安装一个很小的 hook 脚本，并通过 SSH 转发事件回来。",
        "remote_connect": "连接",
        ...
        "update_available_body": "UniIsland %@ 已发布（当前版本：%@），是否前往下载？",
        "download_update": "前往下载",
        "later": "稍后",
        "no_update_title": "已是最新版本",
        "no_update_body": "UniIsland %@ 已是最新版本。",
        "ok": "好",
        "update_now": "立即更新",
        ...
        "update_homebrew_body": "UniIsland %@ 已发布。由于您通过 Homebrew 安装，请运行：",
        "update_homebrew_command": "brew upgrade uniisland",
    ...
    private static let ja: [String: String] = [
        ...
        "shortcut_togglePanel_desc": "UniIsland パネルを開閉します",
        "shortcut_approve": "承認",
        ...
        "system_section": "システム",
        "boot_sound": "起動音",
        "boot_sound_desc": "UniIsland の起動時にジングルを再生します",
        "interaction": "操作",
        ...
        "remote_hint": "ホスト欄には通常のホスト名または ~/.ssh/config のエイリアスを指定できます。UniIsland は小さなリモート hook スクリプトをインストールし、SSH 経由でイベントを転送します。",
        "remote_connect": "接続",
        ...
        "no_update_body": "UniIsland %@ は最新バージョンです。",
        "ok": "OK",
        ...
        "update_homebrew_body": "UniIsland %@ が利用可能です。Homebrew でインストールしたため、次を実行してください:",
        "update_homebrew_command": "brew upgrade uniisland",
    ...
    private static let ko: [String: String] = [
        ...
        "auto_expand_on_completion_desc": "에이전트 또는 하위 에이전트가 완료되면 패널을 잠시 확장합니다. 끄면 UniIsland가 항상 컴팩트 상태로 유지됩니다",
        ...
        "shortcut_togglePanel_desc": "UniIsland 패널을 열거나 닫습니다",
        "shortcut_approve": "승인",
        ...
        "system_section": "시스템",
        "boot_sound": "시작 사운드",
        "boot_sound_desc": "UniIsland가 시작될 때 알림음을 재생합니다",
        "interaction": "상호작용",
        ...
        "remote_hint": "호스트 필드에는 일반 호스트명이나 ~/.ssh/config의 별칭을 사용할 수 있습니다. UniIsland는 작은 원격 hook 스크립트를 설치하고 SSH를 통해 이벤트를 전달합니다.",
        "remote_connect": "연결",
        ...
        "update_available_body": "UniIsland %@ 버전을 사용할 수 있습니다(현재: %@). 다운로드하시겠습니까?",
        "download_update": "다운로드",
        "later": "나중에",
        "no_update_title": "최신 상태",
        "no_update_body": "UniIsland %@이 최신 버전입니다.",
        "ok": "확인",
        "update_now": "지금 업데이트",
        ...
        "update_homebrew_body": "UniIsland %@ 버전을 사용할 수 있습니다. Homebrew로 설치했으므로 다음 명령을 실행하세요:",
        "update_homebrew_command": "brew upgrade uniisland",
    ...
    private static let tr: [String: String] = [
        ...
        "auto_expand_on_completion_desc": "Bir ajan veya alt-ajan işini bitirdiğinde paneli kısa süreliğine genişletir; kapatırsanız UniIsland kompakt durumda kalır",
        ...
        "shortcut_togglePanel_desc": "UniIsland panelini aç veya kapat",
        ...
        "boot_sound_desc": "UniIsland başladığında bir jingle çal",
        ...
        "remote_hint": "Host alanı normal bir hostname veya ~/.ssh/config dosyanızdaki takma ad olabilir. UniIsland küçük bir uzak hook betiği yükler ve olayları SSH üzerinden iletir.",
        ...
        // Window
        "settings_title": "UniIsland Ayarları",
        ...
        "update_available_body": "UniIsland %@ mevcut (şimdiki: %@). İndirmek ister misiniz?",
        "download_update": "İndir",
        "later": "Sonra",
        "no_update_title": "Güncel",
        "no_update_body": "UniIsland %@ en son sürüm.",
        "ok": "Tamam",
        ...
        "update_homebrew_body": "UniIsland %@ mevcut. Homebrew ile yüklediğiniz için, lütfen şunu çalıştırın:",
        "update_homebrew_command": "brew upgrade uniisland",
