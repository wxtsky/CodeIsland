...
private let log = Logger(subsystem: "com.uniisland", category: "HookServer")
...
class HookServer {
    ...
    private static func forwardEventToWebhook(_ event: HookEvent) {
        ...
        request.setValue("UniIsland-Webhook/1.0", forHTTPHeaderField: "User-Agent")
    ...
    /// UniIslandBridge/main.swift), which produces an immediate EOF on the read side.
