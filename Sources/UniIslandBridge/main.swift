// ============================================================
// uniisland-bridge — Native Claude Code hook event forwarder
// ============================================================
...
// • UNIISLAND_SKIP env var support
// • Debug logging (UNIISLAND_DEBUG)
// ============================================================
...
func debugLog(_ message: String) {
    guard ProcessInfo.processInfo.environment["UNIISLAND_DEBUG"] != nil else { return }
    let ts = ISO8601DateFormatter().string(from: Date())
    let line = "[\(ts)] \(message)\n"
    let path = "/tmp/uniisland-bridge.log"
...
// Quick exit: skip if UNIISLAND_SKIP is set
guard env["UNIISLAND_SKIP"] == nil else { exit(0) }
