...
public enum MascotID: UInt8, CaseIterable, Sendable {
    ...
    /// Canonical source name used throughout UniIsland (matches
    ...
    /// Fold a UniIsland source string (including aliases like `traecn`,
...
public struct MascotFramePayload: Equatable, Sendable {
    ...
    /// Build a frame from a canonical source string + UniIsland AgentStatus.
